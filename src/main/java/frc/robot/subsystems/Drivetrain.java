...
public class Drivetrain extends SubsystemBase {
  ...
  private final SparkNovaSwerveModule m_FLModule = new SparkNovaSwerveModule(FrontLeft.kModuleID, FrontLeft.kOffset);
  private final SparkNovaSwerveModule m_FRModule = new SparkNovaSwerveModule(FrontRight.kModuleID, FrontRight.kOffset);
  private final SparkNovaSwerveModule m_RLModule = new SparkNovaSwerveModule(RearLeft.kModuleID, RearLeft.kOffset);
  private final SparkNovaSwerveModule m_RRModule = new SparkNovaSwerveModule(RearRight.kModuleID, RearRight.kOffset);
